    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-md mx-auto space-y-6">
        <div className="flex items-center justify-between">
          ...
          <h1 className="text-4xl font-bold text-primary">{t("shop")}</h1>
          <div className="flex items-center gap-2 bg-card px-4 py-2 rounded-full border-4 border-border">
            <span className="text-2xl">⭐</span>
            <span className="text-xl font-bold text-star">{currentPoints}</span>
          </div>
        </div>
