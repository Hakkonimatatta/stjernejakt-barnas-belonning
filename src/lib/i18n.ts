...
export const translations = {
  no: {
    ...
    syncAcrossDevices: "Samkjøre på flere enheter?",
    syncTapToOpen: "Trykk her for å synkronisere med andre enheter",
    ...
    pointsMax: "Poeng må være mindre enn 100",
    ...
    priceMax: "Pris må være mindre enn 1000 poeng",

    // Sync/QR
    syncDevices: "Samkjør flere enheter",
    syncDescription: "Del data med hverandre for å synkronisere mellom enheter",
    ...
    scanToSync: "Skann koden med en annen enhet for å synkronisere",
    ...
    syncWarning: "Synkroniseringen må gjøres gjentatte ganger. Data blir kun hentet fra øyeblikket koden skannes.",
    ...
    cameraPermissionDenied: "Kamera-tillatelse avslått. Åpne innstillinger og tillat kamera-tilgang.",
